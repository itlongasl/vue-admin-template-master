    ...
    <div>
        ...
        <el-card style="margin:20px 0">
            <div v-show="isShowTabel">
                <el-button type="primary" icon="el-icon-plus" style="margin:20px 0" :disabled="!category3Id"
                ...
                <el-table border style="width: 100%" :data="categoryData">
                    ...
                    <el-table-column label="属性值列表">
                        <template slot-scope="{row,$index}">
                            <el-tag type="success" style="margin:0 5px" v-for="item in row.attrValueList"
                                :key=item.categoryId>{{
                                        item.valueName
                                }}</el-tag>
                        </template>
                    ...
                    <el-table-column prop="address" label="操作" width="150px">
                        <template slot-scope="{row,$index}">
                            <el-button type="warning" icon="el-icon-edit" size="mini" style="margin:0 0 15px"
            ...
            <div v-show="!isShowTabel">
                ...
                <el-table :data="attrInfo.attrValueList" border style="width: 100%;margin:20px 0">
                    ...
                    <el-table-column prop="name" label="属性值名称">
                        <template slot-scope="{row,$index}">
                            <el-input placeholder="请输入属性名" @blur="toLook(row, false)" @keyup.native.enter="toLook(row)"
                                v-if="row.flag" v-model="row.valueName" size="mini" autofocus="autofocus"
                                :ref="$index"></el-input>
