<template>
    <div>
        ...
        <el-card style="margin:20px 0">
            ...
            <div v-show="scene == 0">
                <!-- 添加spu按钮 -->
                <el-button type="primary" icon="el-icon-plus" style="margin:20px 0" @click="addSpu"
                    :disabled="!category3Id">添加Spu属性</el-button>
                <!-- 表格部分 -->
                    ...
                    <el-table-column label="操作">
                        <template slot-scope="{row,$index}">
                            ...
                            <hint-button type="danger" icon="el-icon-delete" size="mini" title="删除spu"
                                @click="deleteSpu(row)"></hint-button>
                        </template>
                    </el-table-column>
                </el-table>
                <!-- 分页部分 -->
                <el-pagination style="text-align:center" :current-page="page" :page-sizes="[3, 5, 7]" :page-size="limit"
                    layout="prev, pager, next, jumper,->, sizes,total" :total="total" :page-count="7"
