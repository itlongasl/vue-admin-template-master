<template>
    <div>
        <el-button type="primary" icon="el-icon-plus" @click="addTradeMark(true)" style="margin:10px 0">添加</el-button>
        <!-- 表格部分 -->
        ...
        <!-- 
         ...
         -->
        <el-pagination style="margin-top:20px;text-align: center;" :current-page="page" :page-sizes="[3, 5, 7]"
