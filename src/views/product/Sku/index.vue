        ...
        <el-card>
            <el-table :data="skuList" border style="width: 100%">
                ...
                <el-table-column label="操作" align="center">
                    <template slot-scope="{row,$index}">
                        ...
                        <el-button type="info" icon="el-icon-bottom" size="mini" v-else
                            @click="cancel(row)"></el-button>
                        <el-button type="primary" icon="el-icon-edit" size="mini"></el-button>
                        <el-button type="info" icon="el-icon-info" @click="getSkuInfo(row)" size="mini"></el-button>
                        <el-button type="danger" icon="el-icon-delete" size="mini"></el-button>
                    </template>
                </el-table-column>
            </el-table>

            <el-pagination style="text-align:center;margin:10px 0" :current-page="1" :page-sizes="[3, 5, 7]"
                :page-size="limit" layout="prev, pager, next, jumper,->, sizes,total" :total="total" :page-count="7"
                @size-change="handleSizeChange" @current-change="getSkuList">
            </el-pagination>
            ...
            <el-drawer title="我是标题" :visible.sync="drawer" size="50%" :with-header="false">
                ...
                <el-row>
                    ...
                    <el-col :span="16">
                        <el-tag type="success" style="margin:5px" v-for="attr in skuInfo.skuAttrValueList"
                            :key="attr.id">{{
                                attr.attrId
                            }}-{{ attr.valueId }}</el-tag>
                    </el-col>
