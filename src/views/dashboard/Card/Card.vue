    ...
    <el-card>
        <div id="main">
            ...
            <div class="card-header">
                <span>{{ title }}</span>
                <svg t="1673850404045" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="2815" width="15" height="15">
                    <path
