    ...
    <div>
        ...
        <el-form :inline="true" :model="cForm" class="demo-form-inline">
            <el-form-item label="一级分类">
                <el-select v-model="cForm.category1Id" placeholder="请选择" @change="getCategort2List" :disabled="show">
                    <!-- v-model将子标签的value的值与category1Id绑定 -->
                    <el-option :label="cate1.name" :value="cate1.id" v-for="cate1 in category1List" :key="cate1.id">{{
                            cate1.name
                    }}</el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="二级分类">
                <el-select placeholder="请选择" v-model="cForm.category2Id" @change="getCategort3List" :disabled="show">
                    <el-option :label="cate2.name" :value="cate2.id" v-for="cate2 in category2List" :key="cate2.id">{{
                            cate2.name
                    }}</el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="三级分类">
                <el-select placeholder="请选择" v-model="cForm.category3Id" @change="handler" :disabled="show">
                    <el-option :label="cate3.name" :value="cate3.id" v-for="cate3 in category3List" :key="cate3.id">{{
                            cate3.name
                    }}</el-option>
                </el-select>
            </el-form-item>
